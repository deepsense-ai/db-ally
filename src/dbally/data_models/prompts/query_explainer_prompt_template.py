    ...
    chat=(
        {
            ...
            "Make your answer as short as possible and start it by infroming the user that the data is too long "
            "to be used in LLM call due to token limit and then describe the table "
            "based on the question and the query.\n"
