...
class IQLFewShotPromptTemplate(IQLPromptTemplate):
    """
    Class for prompt templates meant for the few-shot IQL
    """
    ...
    def __init__(
        ...
        super().__init__(chat, response_format, llm_response_parser)
        self.chat = check_prompt_variables(chat, {"filters", "question", "examples"})
...
default_few_shot_iql_template = IQLFewShotPromptTemplate(
    chat=(
        {
            "role": "system",
            "content": "You have access to API that lets you query a database:\n"
