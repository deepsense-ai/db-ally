...
class NoCollectionFound(DbAllyError):
    """
    Error raised when there is no collection with the given name.
    """

    def __init__(self, collection_name: str) -> None:
        """
        Args:
            collection_name: Name of the view that was not found.
        """
        super().__init__(f"No collection found with name '{collection_name}'.")
        self.view_name = collection_name
