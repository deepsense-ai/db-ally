...
* chore: add issue templates (#48) ([`fa76702`](https://github.com/deepsense-ai/db-ally/commit/fa767022c5ea5e49816321095fda4a20273995f9))

* chore: cleanup changelog (#49) ([`6a3d08f`](https://github.com/deepsense-ai/db-ally/commit/6a3d08fc719e5a912ff3fd7effec732504230a27))

### Documentation

* docs: add about section to documentation (#50) ([`a32b3fe`](https://github.com/deepsense-ai/db-ally/commit/a32b3fe0cee2ee6ab94ceace701c158df5cf2dd4))

### Fix

* fix: gradio interface crash on types that are not json serializable (#47) ([`f501156`](https://github.com/deepsense-ai/db-ally/commit/f501156ab75783b05a0a54af5c047702a53a0a36))

* fix: chromadb dependencies (#51) ([`7a3c2e8`](https://github.com/deepsense-ai/db-ally/commit/7a3c2e871549b83720e398136a50fc0eb62d6ac6))

### Unknown

* Add branches option to on_release trigger ([`a80c9d0`](https://github.com/deepsense-ai/db-ally/commit/a80c9d0b3dec3e68c05a1a965595b500584e163b))

* Add workflow dispatch trigger to docs building ([`0323fb0`](https://github.com/deepsense-ai/db-ally/commit/0323fb05bedff31fb1cbdd6b284e79552a308471))
